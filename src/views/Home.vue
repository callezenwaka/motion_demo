<template>
    ...
    <Header></Header>
        ...
        <div class="aside--content">
          <h1 class="aside--title">Investments</h1>
          <ul>
            <li class="aside--list" style="background-color: #e9e9e9;"><button class="aside--item">Leveraged Buyout (LBO)</button></li>
            <li class="aside--list"><button class="aside--item">Venture Capital</button></li>
            <li class="aside--list"><button class="aside--item">Growth Capital</button></li>
          </ul>
        </div>
        <div class="aside--content">
          <h1 class="aside--title">Exits</h1>
          <ul>
            <li class="aside--list"><button class="aside--item">Initial Public Offering (IPO)</button></li>
            <li class="aside--list"><button class="aside--item">Strategic Sale</button></li>
            <li class="aside--list"><button class="aside--item">Secondary Buyout</button></li>
          </ul>
        </div>
        <div class="aside--content">
          <h1 class="aside--title">Settings</h1>
          <ul>
            <li class="aside--list"><button class="aside--item">Support</button></li>
            <li class="aside--list"><button class="aside--item">Account</button></li>
          </ul>
        </div>
      </aside>
      <main class="main">
        <div>
          <h1>Leveraged Buyout (LBO)</h1>
        </div>
        <div class="main--content">
          <h2>What Is a Leveraged Buyout?</h2>
          <p>
        ...
        <div class="main--content">
          <h2>Understanding Leveraged Buyout (LBO)</h2>
          <p>
        ...
        <div class="main--content">
          <h2>How Does a Leveraged Buyout (LBO) Work?</h2>
          <p>
        ...
        <div class="main--content">
          <h2>Why Do Leveraged Buyouts (LBOs) Happen?</h2>
          <p>
        ...
        <div class="main--content">
          <h2>What Type of Companies Are Attractive For LBOs?</h2>
          <p>
...
.aside--content:hover .aside--title {
  opacity: .5;
}
.aside--title {
